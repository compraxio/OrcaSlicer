...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,               printer_power_watts))
    ((ConfigOptionFloat,               electricity_rate))
    ((ConfigOptionFloat,               printer_purchase_price))
    ((ConfigOptionFloat,               printer_lifetime_hours))
    ((ConfigOptionFloat,               maintenance_cost_per_hour))
    ((ConfigOptionFloat,               fixed_cost_per_print))
    ((ConfigOptionFloat,               profit_margin_percent))
    ((ConfigOptionFloat,               tax_percent))
    ((ConfigOptionFloat,               failure_rate_percent))
